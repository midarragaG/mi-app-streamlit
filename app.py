...
Original file is located at
    https://colab.research.google.com/drive/1dxloV_f8-kNogcYqnjtOPfkZNu2f8i24
...
modelTree,modelKnn, modelNN,min_max_scaler,variables = pickle.load(open(filename, 'rb'))
